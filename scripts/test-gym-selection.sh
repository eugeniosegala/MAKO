...
grep -Fxq 'omitted=vulkan,quality,repeatability,performance,spatial-performance,runtime-overhead,sync-validation,gamescope-e2e,proton-e2e,proton-compatibility' "$test_root/selected.txt"
