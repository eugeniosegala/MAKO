...
grep -Fxq 'omitted=vulkan,quality,repeatability,performance,spatial-performance,runtime-overhead,sync-validation,pacing,external-recovery,gamescope-e2e,direct-desktop-e2e,sustained-health,proton-e2e,proton-compatibility' "$test_root/selected.txt"
