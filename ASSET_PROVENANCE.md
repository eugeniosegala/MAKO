...
| --- | --- | --- |
| `assets/leviathan-rising.png`, `assets/abyss-ascending.png`, `assets/abyssal-fang.png`, `assets/sea-rapture.png` | Maintainer-directed release illustrations, selected and edited for MAKO, including AI-assisted creative tooling. Repository history records their introduction and revisions by Eugenio Segala. No third-party source artwork is intentionally incorporated. | Distributed under GPL-3.0-or-later to the extent copyright or other licensable rights exist and are controlled by the MAKO contributors. |
