...
def generate_typescript_schema():
    ...
    enum_lines = [
        ...
        *runtime_descriptors,
        ...
        "export const ADAPTIVE_FRACTIONAL_REAL_FRAME_PRIORITY_AUTO = "
        f'"{ADAPTIVE_FRACTIONAL_REAL_FRAME_PRIORITY_AUTO}" as const;',
        "export const ADAPTIVE_FRACTIONAL_REAL_FRAME_PRIORITY_LOW = "
        f'"{ADAPTIVE_FRACTIONAL_REAL_FRAME_PRIORITY_LOW}" as const;',
        "export const ADAPTIVE_FRACTIONAL_REAL_FRAME_PRIORITY_MEDIUM = "
        f'"{ADAPTIVE_FRACTIONAL_REAL_FRAME_PRIORITY_MEDIUM}" as const;',
        "export const ADAPTIVE_FRACTIONAL_REAL_FRAME_PRIORITY_HIGH = "
        f'"{ADAPTIVE_FRACTIONAL_REAL_FRAME_PRIORITY_HIGH}" as const;',
        "export const ADAPTIVE_FRACTIONAL_REAL_FRAME_PRIORITY_VERY_HIGH = "
        f'"{ADAPTIVE_FRACTIONAL_REAL_FRAME_PRIORITY_VERY_HIGH}" as const;',
        "export const ADAPTIVE_FRACTIONAL_REAL_FRAME_PRIORITY_VALUES = [",
        *(
            "  ADAPTIVE_FRACTIONAL_REAL_FRAME_PRIORITY_" +
            value.replace("-", "_").upper() + ","
            for value in ADAPTIVE_FRACTIONAL_REAL_FRAME_PRIORITY_VALUES
        ),
        "] as const;",
        ...
        *(
        ...
        "export const SCALING_SHARPNESS_MIN = "
        f"{SCALING_SHARPNESS_MIN} as const;",
        "export const SCALING_SHARPNESS_MAX = "
        f"{SCALING_SHARPNESS_MAX} as const;",
        ...
        "export const VKBASALT_SHADER_HDR_LOOK = "
        f'"{VKBASALT_SHADER_HDR_LOOK}" as const;',
        "export const VKBASALT_SHADER_COLOURFULNESS = "
        f'"{VKBASALT_SHADER_COLOURFULNESS}" as const;',
        "export const VKBASALT_SHADER_TECHNICOLOR2 = "
        f'"{VKBASALT_SHADER_TECHNICOLOR2}" as const;',
        "export const VKBASALT_SHADER_DPX = "
        f'"{VKBASALT_SHADER_DPX}" as const;',
        "export const VKBASALT_SHADER_BLEACH_BYPASS = "
        f'"{VKBASALT_SHADER_BLEACH_BYPASS}" as const;',
        "export const VKBASALT_SHADER_NOIR = "
        f'"{VKBASALT_SHADER_NOIR}" as const;',
        "export const VKBASALT_SHADER_FILM_GRAIN = "
        f'"{VKBASALT_SHADER_FILM_GRAIN}" as const;',
        "export const VKBASALT_SHADER_CARTOON = "
        f'"{VKBASALT_SHADER_CARTOON}" as const;',
        "export const VKBASALT_SHADER_NOSTALGIA = "
        f'"{VKBASALT_SHADER_NOSTALGIA}" as const;',
        "export const VKBASALT_SHADER_CHROMATIC_ABERRATION = "
        f'"{VKBASALT_SHADER_CHROMATIC_ABERRATION}" as const;',
        "export const VKBASALT_SHADER_CLARITY = "
        f'"{VKBASALT_SHADER_CLARITY}" as const;',
        "export const VKBASALT_SHADER_LEVELS_PLUS = "
        f'"{VKBASALT_SHADER_LEVELS_PLUS}" as const;',
