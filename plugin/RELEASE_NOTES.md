...
- **Live vkBasalt tuning:** Sharpness and DLS denoise now update in a running game when MAKO's bundled vkBasalt layer is active. Layer activation and effect selection remain restart-bound.
