...
- **More breathing room in the balanced quality profile:** MAKO Decky's normal Flow Scale now starts at 0.85 instead of 0.90, reducing optical-flow work without enabling the lighter model or Ultra Performance's more aggressive 0.75 preset. Existing profiles retain their saved choice, while new profiles and the reset from Ultra Performance use the new balanced default.
