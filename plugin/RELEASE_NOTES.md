...
- **Partial HDR support:** An Advanced Rendering toggle and live 203–1000-nit target keep the game and MAKO in SDR while Gamescope maps the final image through a supported HDR display. Keep HDR on in Steam and off in the game. HDR game content, Frame Generation, and Scaling remain unavailable.
