...
describe("MAKO section headers", () => {
  test("centers the title above the solid dense-purple four-pixel divider", () => {
    window.SP_REACT = React;
    ...
    expect(heading.style.borderBottom).toBe("4px solid rgb(85, 56, 120)");
...
describe("MAKO restart labels", () => {
  test("renders only the translated parenthetical marker at a smaller size", () => {
    ...
    expect(container.textContent).toBe("スケーリング（再起動）");
  });
