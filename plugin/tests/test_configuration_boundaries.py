...
class ConfigurationBoundaryTests(unittest.TestCase):
    ...
    def test_default_wrapper_bytes_are_characterized(self):
        ...
        self.assertEqual(len(content.encode("utf-8")), 3784)
        self.assertEqual(
            _sha256(content),
            "135de2fb25ee95bee74ea3d5a4e3eb3b5cbdbd29592efa6511c31c7b025575b1",
        )
        self.assertEqual(
    ...
    def test_multi_profile_wrapper_bytes_are_characterized(self):
        ...
        self.assertEqual(len(content.encode("utf-8")), 5784)
        self.assertEqual(
            _sha256(content),
            "07f82ae8bd3bbaf415160374450b925eee18363bbb7714f024fc7ac6db1566b7",
        )
        self.assertEqual(
    ...
    def test_unsupported_host_passthrough_bytes_are_characterized(self):
        ...
        self.assertEqual(
            _sha256(content),
            "da01e4aa5e2e8d1e88ba751651fb2622799550bb9a4d4c2c3fc4ad987082c165",
        )
