...
class ConfigurationBoundaryTests(unittest.TestCase):
    ...
    def test_default_wrapper_bytes_are_characterized(self):
        ...
        self.assertEqual(len(content.encode("utf-8")), 9463)
        self.assertEqual(
            _sha256(content),
            "64d3f1b9d9bfc85181ead553a67a7f611b462fa19dc0c13dd037cfdd016100f8",
        )
        self.assertEqual(
    ...
    def test_multi_profile_wrapper_bytes_are_characterized(self):
        ...
        self.assertEqual(len(content.encode("utf-8")), 11635)
        self.assertEqual(
            _sha256(content),
            "c67b5d275a00028800578b50fd4292fdfed210a84a565dc91ca88e3fa38dd6ce",
        )
        self.assertEqual(
    ...
    def test_unsupported_host_passthrough_bytes_are_characterized(self):
        ...
        self.assertEqual(
            _sha256(content),
            "5e3fdaf3a5be02244d516301d818b1188e3e8f3a07a6be14727fbcf58b064a35",
        )
