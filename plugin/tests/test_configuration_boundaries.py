...
class ConfigurationBoundaryTests(unittest.TestCase):
    ...
    def test_default_wrapper_bytes_are_characterized(self):
        ...
        self.assertEqual(
            _sha256(content),
            "5a951e521cb674a1ec8ff31be66edd68ddbd90e2d34f832ab54ca8e7fc8b2c59",
        )
        self.assertEqual(
    ...
    def test_multi_profile_wrapper_bytes_are_characterized(self):
        ...
        self.assertEqual(
            _sha256(content),
            "7a6bc3a0f3b0f3cf545679e0aa7e6cc4f715a1878580a1c52bb072c232ed4e73",
        )
        self.assertEqual(
    ...
    def test_unsupported_host_passthrough_bytes_are_characterized(self):
        ...
        self.assertEqual(
            _sha256(content),
            "8d524be63a1f755b9a532776ad4eacfa21286348035de2b3ffb572003e18f7b2",
        )
