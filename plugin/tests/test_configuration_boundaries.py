...
class ConfigurationBoundaryTests(unittest.TestCase):
    ...
    def test_default_wrapper_bytes_are_characterized(self):
        ...
        self.assertEqual(len(content.encode("utf-8")), 9881)
        self.assertEqual(
            _sha256(content),
            "972703b6a1ffff23fec15465eb1c7f9103034df065190a9d1c76befaf7b6ce17",
        )
        self.assertEqual(
    ...
    def test_multi_profile_wrapper_bytes_are_characterized(self):
        ...
        self.assertEqual(len(content.encode("utf-8")), 12053)
        self.assertEqual(
            _sha256(content),
            "4c5d6416e790597268ac651ed4e7ecccc91fce994463cdb35ce5e70bb572b31e",
        )
        self.assertEqual(
    ...
    def test_unsupported_host_passthrough_bytes_are_characterized(self):
        ...
        self.assertEqual(
            _sha256(content),
            "45d4d9ac52ac412e8f91a9adda1f9bce94c1f9cc3e2431702f8bd8e75dc8f856",
        )
