...
class ConfigurationBoundaryTests(unittest.TestCase):
    ...
    def test_default_wrapper_bytes_are_characterized(self):
        ...
        self.assertEqual(
            _sha256(content),
            "067d428db286a28c3e52ee7029fb3be081c2919ee44421b88a0f7384ec7e7ae2",
        )
        self.assertEqual(
    ...
    def test_multi_profile_wrapper_bytes_are_characterized(self):
        ...
        self.assertEqual(
            _sha256(content),
            "3626dff9f9aa25afe023d20ccbfb8fa5b54b266a9b1b0257c8338330748cf8f5",
        )
        self.assertEqual(
    ...
    def test_unsupported_host_passthrough_bytes_are_characterized(self):
        ...
        self.assertEqual(
            _sha256(content),
            "b925c4718c8568c6c0d80392ba09c14c102d26b6fb56d9e97f0c118821adda31",
        )
