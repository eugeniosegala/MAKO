...
- [ADAPATIVE Frame Gen Is A GAME CHANGER For The Steam Deck! 5 AAA Games TESTED!](https://www.youtube.com/watch?v=FPMydqK4b2Q)
  ...
  Steam Deck games.
- [SteamOS installation and usage guide](https://www.youtube.com/watch?v=d_Po25-MXas)
...
- [Lossless Scaling V.2 с адаптивной генерацией кадров на Steam Deck+Тесты](https://www.youtube.com/watch?v=bO-CHaTD0Qs)
  by [Андрей-Канал Солянка](https://www.youtube.com/@Andrey_6777): Russian-language testing of v2 Adaptive Frame
  Generation on Steam Deck.
- [Lossless Scaling V.2 установка пошагово.](https://www.youtube.com/watch?v=sR3PXcudM5E)
  by [Андрей-Канал Солянка](https://www.youtube.com/@Andrey_6777): Russian-language step-by-step installation guide.
- [Korean-language installation and game-setup guide](https://www.youtube.com/watch?v=2DX4B81gtK0)
  by [더 히트 THE HEAT](https://www.youtube.com/@%EB%8D%94%ED%9E%88%ED%8A%B8TheHeat): Korean-language installation and
  game-setup guide for the v2 build.
...
- [Oblivion Remastered on Steam Deck | FSR 4.1 + LSFG-VK 2.0 + Eclipse Mod Performance Test](https://www.youtube.com/watch?v=fd9xSamlUZI)
  by [Deck Madness](https://www.youtube.com/@deck_madness): Steam Deck performance test using FSR 4.1, LSFG-VK 2.0,
  and Eclipse Mod.
- [Final Fantasy VII Rebirth on Steam Deck | FSR 4.1 + LSFG-VK 2.0 + Eclipse Mod Performance Test](https://www.youtube.com/watch?v=ysNx7VrOJlc)
  by [Deck Madness](https://www.youtube.com/@deck_madness): Steam Deck performance test using FSR 4.1, LSFG-VK 2.0,
  and Eclipse Mod.
...
Coverage reflects each creator's own hardware, game settings, and conclusions. It is not an endorsement or a
guarantee that a particular game will behave the same way on every system.
