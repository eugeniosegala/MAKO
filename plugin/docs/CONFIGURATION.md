...
The Effects picker expands into a compact checklist in Decky's side panel, leaving the game visible while you compare changes. Use the page arrows to reach more effects, then select **Done** to collapse it; other dialogs keep their normal behavior.
