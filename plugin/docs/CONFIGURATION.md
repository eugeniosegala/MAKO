...
- **Base FPS Cap:** Caps real frames before generation. Decky offers Off–120 FPS; choose a cap that fits the display and generation ratio, such as 60 real FPS for a steady 120 FPS 2x path. It applies live and is disabled while **Steady Base Cap** controls the cap.
