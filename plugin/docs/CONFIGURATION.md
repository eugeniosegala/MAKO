...
- **Real Frame Priority:** Appears only in Fractional Adaptive. Automatic is the default and preserves Fractional Adaptive's existing behavior, including the editable Base FPS Cap. Low, Medium, High, and Very High select stable 3:2, 2:1, 3:1, and 4:1 real/generated ratios, respectively. An explicit priority owns the real-frame cap, leaves the saved manual value untouched, and disables Dynamic Cadence Recovery.
