...
export const checkMakoInstalled = callable<[], InstallationStatus>("check_mako_installed");
...
export const updateMakoConfigFromObject = async (config: ConfigurationData): Promise<ConfigUpdateResult> => {
