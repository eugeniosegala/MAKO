...
| **MAKO Renderer** | Direct Vulkan-layer installation without Decky | [Latest MAKO Renderer release (Linux archive under Assets)](https://github.com/eugeniosegala/MAKO/releases/tag/render-v1.1.2) |
...
2. Open the [latest MAKO Renderer release](https://github.com/eugeniosegala/MAKO/releases/tag/render-v1.1.2) and download the Linux archive under **Assets**, named `mako-render-v<version>-linux.tar.xz`.
