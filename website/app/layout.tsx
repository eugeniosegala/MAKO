...
export const metadata: Metadata = {
  ...
  description: 'MAKO brings Vulkan spatial scaling—proprietary LS1 and the open MAKO scaler—plus LSFG frame generation to Steam Deck, Steam Machine, SteamOS, and Linux.',
