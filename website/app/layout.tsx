...
export const metadata: Metadata = {
  ...
  description: 'MAKO brings Vulkan-powered Lossless Scaling frame generation to Steam Deck, SteamOS, and Linux.',
  ...
  openGraph: {
    title: 'MAKO - Frame Generation on SteamOS/Linux',
    description: 'MAKO brings Lossless Scaling frame generation to Steam Deck, SteamOS, and Linux.',
