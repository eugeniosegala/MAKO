...
- Treat `engine/build/`, `engine/out/`, `.pnpm-store/`, `plugin/.pnpm-store/`, `plugin/dist/`, `plugin/out/`, `plugin/coverage/`, `plugin/node_modules/`, `website/node_modules/`, `website/dist/`, `website/dist-pages/`, `website/.vinext/`, `website/.next/`, and Python `__pycache__/` directories as generated or local cache data. Do not hand-edit or commit their contents.
