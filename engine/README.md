...
4. Select Fixed or Adaptive Frame Generation and/or **Scaling (Restart)**. For scaling, choose the method and factor and lower the game's resolution as described in [desktop scaling and resolution](docs/CONFIGURATION.md#desktop-scaling-and-resolution).
