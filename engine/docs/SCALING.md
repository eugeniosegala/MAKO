...
| Lifecycle | Initial create, focus and overlay transitions, private Native/MAKO/LS1 model and sharpness changes with zero application-visible recreation, simultaneous or superseded private FG model/Flow/capacity changes, Scale Factor deferral, game-owned resolution change, natural swapchain recreation, process-restart scaling changes, profile update, and shutdown. |
