...
| Scaling factor | Game-owned recreation | Existing context retains its extent contract; after edits settle, the managed Gamescope upper combined role or a compatible non-Gamescope maintenance1 context requests one recreation after a fenced present, while the lower Gamescope capability/extent role and contexts without retirement proof wait for the next natural resolution/surface recreation |
