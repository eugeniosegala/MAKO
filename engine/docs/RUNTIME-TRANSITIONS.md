...
- Do not initiate game-owned swapchain destruction. Preserve the one-shot, retirement-fenced out-of-date request, remove a game-destroyed context from live updates immediately, and defer its lower WSI destruction until the replacement-present, grace-period, and fence conditions are all satisfied.
