...
| Gamescope VRR and Allow Tearing feedback | Live | Explicit requested/capable/active VRR can change Steady Adaptive's higher-multiplier cap eligibility. Fixed Smooth Cadence and validated Steady Adaptive 2x retain ordered FIFO pacing. Only affected pacing helpers reset; Allow Tearing is diagnostic only. |
