...
| --- | --- | --- |
| Steam Deck / AMD RDNA2 / Gamescope | DXVK (DX11) | Fixed baseline, Adaptive steady target, Steam overlay, live Off → On, normal 0.90 quality model versus Ultra Performance 0.70 lighter model after restart |
