...
| Adaptive post-menu watchdog | Confirmed focus round trip; 1 second at 95% of target before opening; then 4 seconds below 75% with at least 50% lower-present time; Frame Generation-only context | At most two guarded requests per 75-second episode, at least 30 seconds apart; combined scaling recovers in place or through natural recreation, and unknown/stale focus or policy/geometry changes invalidate evidence |
