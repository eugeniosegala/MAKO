...
- **`flow_scale`**: Motion-vector resolution from 0.25 to 1.0. Lower is faster; higher favours image quality. A running context retains its actual flow resources until the game's next natural swapchain recreation or restart. Default: `1.0`.
