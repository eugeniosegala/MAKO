...
MAKO Decky uses its own safer UI defaults: 90 FPS Adaptive target, 0.85 Flow Scale, and Smooth Cadence enabled when it creates a profile. Those defaults do not change the direct Renderer defaults above.
