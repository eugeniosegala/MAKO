...
- **Standalone tools now speak more languages:** The optional desktop UI automatically selects and remembers English, Brazilian Portuguese, European Portuguese, Spanish, Korean, Japanese, or Simplified Chinese, matching MAKO Decky's supported languages. The CLI offers English, Brazilian Portuguese, European Portuguese, and Spanish through an explicit `--lang` option without changing Renderer profiles or machine-oriented quality output.
